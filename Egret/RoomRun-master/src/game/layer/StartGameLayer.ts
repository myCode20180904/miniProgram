...
class StartGameLayer extends egret.Sprite {
    ...
    /**技能容器 */
	private skillContianer:SkillContianer;
    public constructor() {
        super();
        this.init();
    }
    private init():void {
        ...
        this.skillContianer = new SkillContianer();
        this.addChild(this.skillContianer);
    }
    private onStartGameClick(evt:egret.TouchEvent) {
