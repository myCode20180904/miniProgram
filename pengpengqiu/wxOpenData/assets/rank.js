...
cc.Class({
    ...
    Scroll_View:function(rankdata){
        ...
        let row = 0;
        let col = 0;
        this.scrollView.getComponent(cc.ScrollView).content.height = size*112
        let selfinfo = 0;
        for (let index = 0; index <size; index++) {
            ...
            item.getChildByName("score").getComponent(cc.Label).string = score;
        ...
        if(selfinfo){
            ...
            this.item.getChildByName("name").getComponent(cc.Label).string = selfinfo.nickname;
            this.item.getChildByName("score").getComponent(cc.Label).string = selfinfo.score;
            let head_self =  this.item.getChildByName("iconMask").getChildByName("head");
            this.loadHttpIcon(head_self,selfinfo.avatarUrl,function(){});
