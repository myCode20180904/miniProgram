...
var gamedata = {
    ...
    startGame:function(){
        ...
        for (let index = 0; index < len; index++) {
            ...
            let one_player = {
                startSpeed:(index == 0)?gamedata.gameConf.baseSpeed*myscan.attribute.speed:gamedata.gameConf.baseSpeed*0.4*scan.attribute.speed,
                startScale:(index == 0)?myscan.attribute.scale*0.3:scan.attribute.scale*0.3,
                startForce:(index == 0)?myscan.attribute.fcore:scan.attribute.fcore,//出生的力量
                speed:(index == 0)?gamedata.gameConf.baseSpeed*myscan.attribute.speed:gamedata.gameConf.baseSpeed*0.4*scan.attribute.speed,
                force:(index == 0)?myscan.attribute.fcore:scan.attribute.fcore,
                getForce:1,
                rotateSpeed:0.8,
                dir:cc.v2(0,0),
                level:1,
                name:(index == 0)?userInfo.getData.name:scan.name,
